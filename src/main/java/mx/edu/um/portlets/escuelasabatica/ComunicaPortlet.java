...
public class ComunicaPortlet {
    ...
    public ComunicaPortlet() {
        log.debug("Se ha creado una nueva instancia del portlet de comunica");
    }

    @RequestMapping
    public String ver(RenderRequest request, RenderResponse response, Model model) {
        log.debug("Mostrando blogs de comunica");
        TimeZone tz = null;
        ...
        try {
            ...
            zone = DateTimeZone.forID(ComunicaPortlet.getConvertedId(tz.getID()));
        }
        try {
